...
export class PlanetsService {
	...
	public getPlanet(planetName: 'Mercury' | 'Venus' | 'Earth' | 'Mars' | 'Jupiter' | 'Saturn' | 'Uranus' | 'Neptune'): Observable<any> {
		let _planet = this.planets.filter((planet: any) => planet.name === planetName);
		return of(_planet);
	}
